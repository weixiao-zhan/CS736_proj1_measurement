...
echo 'done'
./measure_basava 2 1 1  > ./results_vary_buf/basava__Socket__RDTSC__THR.csv
echo 'done'
./measure_basava 2 2 1  > ./results_vary_buf/basava__Socket__ClockMono__THR.csv
echo 'done'
./measure_basava 2 3 1  > ./results_vary_buf/basava__Socket__TimeOfDay__THR.csv
echo 'done'
